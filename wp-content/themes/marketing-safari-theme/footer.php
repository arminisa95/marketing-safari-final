<footer class="site-footer">
  <div class="footer-wave">
    <svg viewBox="0 0 1920 120" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M-52 60C43 27 277 0 572 0C940 0 1196 80 1516 80C1836 80 1890 30 1972 22L1972 120L-52 120Z" fill="#FFEF5F"/>
    </svg>
    <div class="footer-wave-text">Mit Marketing Safari – nie den Überblick zwischen Content-Ideen, Anzeigen und Tools verlieren.</div>
  </div>
  <div class="footer-body">
    <div class="container footer-inner">
      ...
      <div class="footer-contact-col">
        ...
        <p>Mühlgruberstraße 42,<br>4540 Pfarrkirchen bei Bad Hall</p>
      </div>
    </div>
